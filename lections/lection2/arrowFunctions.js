// Создаем объект, у которого методы определены через стрелочную функцию
const Roomba = {
    model: "Romba-1",
    power: 200,
    batterySize: 2100,
...
// Вызываем наши методы разными способами
// Объект Roomba - робот-пылесос. Код самого объекта смотри выше, с использованием синтаксиса ES2015.
